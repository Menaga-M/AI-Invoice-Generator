...
const getDashboardSummary = async (req, res) => {
    try {
        ...
        Based on the following summary of their invoice date, provide 2-3 concise and actionable insights.
        ...
        For example, if there is a hight outstanding amount, suggest sending remainders. If revenue is high, be encouraging.
