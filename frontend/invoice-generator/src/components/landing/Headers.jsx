        ...
        <div className = "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16 lg:h-20">
                ...
                <div className="hidden lg:flex items-center space-x-4">
                    {isAutenticated ? <ProfileDropdown isOpen = {profileDropdownOpen} onToggle = {(e) => {
                        e.stopPropagation();
                    ...
                    email={user?.email || ""}
                    onLogout ={logout}/> : <><Link to="/login" className="text-black hover:text-gray-900 font-medium transition-colors duration-200">
                        Login
                    </Link>
